...
contract EnterpriseVault {
    ...
    /**
     * Internal calculation logic to obfuscate the execution flow.
     */
     ...
     * VULNERABILITY: Reentrancy possible due to state update after external call.
     * CONDITION: Triggers only for high-balance users (whales) with specific timing.
     */
    function sweepLoyaltyBonus() external {
        ...
        // Obfuscated through realistic external call for 'gas-efficient' transfer
